...
<template>
 ...
 <div>
 <h3 class="text-xl font-black ">Esquema editable</h3>
 ...
 <p v-if="cargando" class="text-sm ">Cargando esquemas...</p>
 <p v-else-if="!schemaDraft" class="text-sm ">No hay esquema seleccionado.</p>

 <article v-else class="rounded-2xl border p-5">
 <div class="flex flex-wrap items-center justify-between gap-3">
 <div>
 <h4 class="text-lg font-black ">{{ schemaDraft.title || selectedSchema?.title || "Nuevo esquema" }}</h4>
 <p class="text-xs ">
 ...
 <label class="space-y-1">
 <span class="text-xs font-semibold ">Tipo de almacenamiento</span>
 <select
 ...
 <label class="space-y-1">
 <span class="text-xs font-semibold ">Colección</span>
 <input
 ...
 <label class="space-y-1">
 <span class="text-xs font-semibold ">Slug desde campo</span>
 <input
 ...
 <label class="space-y-1">
 <span class="text-xs font-semibold ">Campo de preview</span>
 <input
 ...
 <span class="text-xs font-semibold ">Dictionary document ID</span>
 <input
 ...
 <label v-if="schemaDraft.storageType === 'dictionary'" class="space-y-1">
 <span class="text-xs font-semibold ">Dictionary root key</span>
 <input
 ...
 <h5 class="text-sm font-black uppercase tracking-wide ">Campos</h5>
 <button
 type="button"
 class="rounded-md border px-3 py-1.5 text-xs font-semibold "
 @click="agregarCampo"
